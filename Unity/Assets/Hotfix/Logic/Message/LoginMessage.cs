...
namespace ET {
  ...
  public partial class Msg_PlayerInfo : pb::IMessage {
    private static readonly pb::MessageParser<Msg_PlayerInfo> _parser = new pb::MessageParser<Msg_PlayerInfo>(() => (Msg_PlayerInfo)MessagePool.Instance.Fetch(typeof(Msg_PlayerInfo)));
    ...
    public int CalculateSize() {
      ...
      if (Goldens != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(Goldens);
      }
      if (Diamods != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(Diamods);
      }
      return size;
    }
  ...
  public partial class G2C_PlayerInfo : pb::IMessage {
    ...
    private global::ET.Msg_PlayerInfo playerInfo_;
    public global::ET.Msg_PlayerInfo PlayerInfo {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (playerInfo_ == null) {
              playerInfo_ = new global::ET.Msg_PlayerInfo();
            }
