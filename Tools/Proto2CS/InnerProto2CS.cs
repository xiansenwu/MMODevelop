...
namespace ETTools
{
    public static class InnerProto2CS
    {
        ...
        private static string serverMessagePath = "../Server/Model/Module/Message/Inner/";
        private static readonly char[] splitChars = { ' ', '\t' };
        private static readonly List<OpcodeInfo> msgOpcode = new List<OpcodeInfo>();
        private static int startOpcode = 1000;
        public static void Run(string folderPath)
        {
            ...
            foreach (FileInfo NextFile in fileInfo)  //遍历文件
            {
                ...
                {
                    ProtoToCS("ET", NextFile.Name, serverMessagePath, "InnerOpcode");
                }
            }
            GenerateOpcode("ET", "InnerOpcode", serverMessagePath);
        }

        public static void ProtoToCS(string ns, string protoName, string outputPath, string opcodeClassName)
        {
            //msgOpcode.Clear();
